...
<head>
    ...
    <meta charset="utf-8" />
    <title>Master Panel Generator</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="A fully featured admin theme which can be used to build CRM, CMS, etc." name="description" />
    <meta content="Coderthemes" name="author" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <!-- App favicon -->
    <?= $this->include('part/css') ?>
</head>
...
<body class="loading" data-layout-mode="horizontal" data-layout='{"mode": "light", "width": "fluid", "menuPosition": "fixed", "topbar": {"color": "dark"}, "showRightSidebarOnPageLoad": true}'>
            ...
            <div class="container-fluid">
                ...
                <ul class="list-unstyled topnav-menu float-end mb-0">
                    ...
                    <li class="dropdown d-none d-lg-inline-block topbar-dropdown">
                        <a class="nav-link dropdown-toggle arrow-none waves-effect waves-light" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            <i class="mdi mdi-grid noti-icon "></i>
                        </a>
                        <div class="dropdown-menu dropdown-lg dropdown-menu-end p-0">
                    ...
                    <li class="dropdown d-none d-lg-inline-block topbar-dropdown">
                        <a class="nav-link dropdown-toggle arrow-none waves-effect waves-light" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            <img src="<?= base_url('assets/images/flags/us.jpg') ?>" alt="user-image" height="14">
                        </a>
                    ...
                    <li class="dropdown notification-list">
                        <a href="javascript:void(0);" class="nav-link right-bar-toggle waves-effect waves-light">
                            <i class="mdi mdi-cog-outline noti-icon "></i>
                        </a>
                    </li>
                    ...
                    <div class="p-2">
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="d-flex align-items-start">
                                <div class="position-relative me-2">
                                    ...
                                    <img src="<?= base_url('assets/images/users/avatar-10.jpg') ?>" class="rounded-circle avatar-sm" alt="user-pic">
                                </div>
                        ...
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="d-flex align-items-start">
                                <div class="position-relative me-2">
                                    <span class="user-status"></span>
                                    <img src="<?= base_url('assets/images/users/avatar-1.jpg') ?>" class="rounded-circle avatar-sm" alt="user-pic">
                                </div>
                                <div class="flex-1 overflow-hidden">
                        ...
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="d-flex align-items-start">
                                <div class="position-relative me-2">
                                    ...
                                    <img src="<?= base_url('assets/images/users/avatar-9.jpg') ?>" class="rounded-circle avatar-sm" alt="user-pic">
                                </div>
                                <div class="flex-1 overflow-hidden">
                    ...
                    <div class="p-2 pb-4">
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="d-flex align-items-start">
                                <div class="position-relative me-2">
                                    ...
                                    <img src="<?= base_url('assets/images/users/avatar-2.jpg') ?>" class="rounded-circle avatar-sm" alt="user-pic">
                                </div>
                                <div class="flex-1 overflow-hidden">
                        ...
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="d-flex align-items-start">
                                <div class="position-relative me-2">
                                    ...
                                    <img src="<?= base_url('assets/images/users/avatar-4.jpg') ?>" class="rounded-circle avatar-sm" alt="user-pic">
                                </div>
                                <div class="flex-1 overflow-hidden">
                        ...
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="d-flex align-items-start">
                                <div class="position-relative me-2">
                                    <span class="user-status online"></span>
                                    <img src="<?= base_url('assets/images/users/avatar-5.jpg') ?>" class="rounded-circle avatar-sm" alt="user-pic">
                                </div>
                                <div class="flex-1 overflow-hidden">
                        ...
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="d-flex align-items-start">
                                <div class="position-relative me-2">
                                    <span class="user-status busy"></span>
                                    <img src="<?= base_url('assets/images/users/avatar-7.jpg') ?>" class="rounded-circle avatar-sm" alt="user-pic">
                                </div>
                                <div class="flex-1 overflow-hidden">
                        ...
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="d-flex align-items-start">
                                <div class="position-relative me-2">
                                    <span class="user-status away"></span>
                                    <img src="<?= base_url('assets/images/users/avatar-8.jpg') ?>" class="rounded-circle avatar-sm" alt="user-pic">
                                </div>
                                <div class="flex-1 overflow-hidden">
    ...
    <?= $this->include('part/js') ?>
    <?= $this->include('part/jsfunction') ?>
    <?= $this->include('part/jsmenu') ?>

    <?= $this->include('part/modal') ?>
