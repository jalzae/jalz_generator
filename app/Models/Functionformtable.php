...
class Functionformtable extends Model
{

	protected $DBGroup              = "default";
	protected $table                = "function_form";
	...
	{
		return $this->db->table($this->table)->update($data, ["id_function" => $id]);
	}
	...
	{
		return $this->db->table($this->table)->delete(["id_function" => $id]);
	}
